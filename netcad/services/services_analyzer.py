...
class ServicesAnalyzer:
    ...
    def __init__(self, design: "Design"):
        ...
        self.devices = {dev_obj for dev_obj in  design.devices.values()
                        if not dev_obj.is_pseudo}
    ...
    def add_edge(self, source, target, **kwargs):
        self.graph.add_edge(self.nodes_map[source].index, self.nodes_map[target].index, **kwargs)
    ...
    def analyze(self, svc):
        root_node = self.nodes_map[svc]
        breakpoint()
        x=1
    ...
    def _add_result_nodes(self, device: "Device", feature: "DesignFeature", results: Iterator[CheckResult]):
